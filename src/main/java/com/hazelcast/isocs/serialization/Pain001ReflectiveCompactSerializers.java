...
/** Diagnostic explicitly registered serializers backed by reflective field access. */
public final class Pain001ReflectiveCompactSerializers {
    private Pain001ReflectiveCompactSerializers() {
    }
